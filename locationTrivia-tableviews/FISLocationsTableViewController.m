...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    FISLocation *location = self.locations[currentRow];
    
    NSUInteger numOfTriviaPerLocation = [location.trivia count];
    
    cell.textLabel.text = location.name;
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%ul", numOfTriviaPerLocation];
